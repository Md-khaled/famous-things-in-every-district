            ...
            <div class="sidebar-inner">
                <div class="sidebar-logo">
                    <div class="peers ai-c fxw-nw">
                        <div class="peer peer-greed"><a class="sidebar-link td-n" href="dashboard.php" class="td-n">
                                <div class="peers ai-c fxw-nw">
                                    <div class="peer">
                                        <div class="logo">
                                            ...
                                            <img data-cfsrc="assets/static/images/logo.png" alt="" style="display:none;visibility:hidden;"><noscript><img src="assets/static/images/logo.png" alt=""></noscript>
                                        </div>
                                    </div>
                ...
                <ul class="sidebar-menu scrollable pos-r">
                    ...
                    <li class="nav-item dropdown"><a class="dropdown-toggle" href="javascript:void(0);"><span class="icon-holder"><i class="c-red-500 ti-files"></i> </span><span class="title">Color</span> <span class="arrow"><i class="ti-angle-right"></i></span></a>
                        <ul class="dropdown-menu">
                            <li><a class="sidebar-link" href="colorAdd.php">Add Color </a></li>
                            <li><a class="sidebar-link" href="colorlist.php">Color List</a></li>
                        </ul>
                    </li>
