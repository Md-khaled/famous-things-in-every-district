                ...
                <div class="header-container">
                    ...
                    <ul class="nav-right">
                                ...
                                <li>
                                    <ul class="ovY-a pos-r scrollable lis-n p-0 m-0 fsz-sm">
                                        ...
                                        <li><a href="replymsg.php?rmsgid=<?php echo($re['contactid']); ?>" class="peers fxw-nw td-n p-20 bdB c-grey-800 cH-blue bgcH-grey-100">
                                                <div class="peer mR-15"><img class="w-3r bdrs-50p" data-cfsrc="https://randomuser.me/api/portraits/men/1.jpg" alt="" style="display:none;visibility:hidden;"><noscript><img class="w-3r bdrs-50p" src="../../../randomuser.me/api/portraits/men/1.jpg" alt=""></noscript></div>
                        ...
                        <li class="dropdown"><a href="#" class="dropdown-toggle no-after peers fxw-nw ai-c lh-1" data-toggle="dropdown">
                                <div class="peer mR-10"><img class="w-2r bdrs-50p" data-cfsrc="https://randomuser.me/api/portraits/men/10.jpg" alt="" style="display:none;visibility:hidden;"><noscript><img class="w-2r bdrs-50p" src="../../../randomuser.me/api/portraits/men/10.jpg" alt=""></noscript></div>
                                <div class="peer"><span class="fsz-sm c-grey-900"><?php echo(Session::get('adminName')); ?></span></div>
                            </a>
                            <ul class="dropdown-menu fsz-sm">
                                <li><a href="changepassword.php" class="d-b td-n pY-5 bgcH-grey-100 c-grey-700"><i class="ti-settings mR-10"></i> <span>PassChange</span></a></li>
