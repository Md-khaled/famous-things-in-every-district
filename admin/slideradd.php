            ...
            <div class="masonry-item col-md-12">
                <div class="bgc-white p-20 bd">
                    ...
                    <div class="alert alert-success alert-dismissible" data-auto-dismiss="2000" role="alert">
                        ...
                        <strong>Success!</strong> <?php echo('insert successfully');?>
                    </div>
                  <?php }?>
                   <?php if(isset($insertCat) && $insertCat!='success') {?>
                    ...
                    <div class="mT-30">
                        <form  method="post" enctype="multipart/form-data">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="title" placeholder="Enter Slider Title..."> 
                            </div>
                            ...
                            <div class="form-group">
                                <label for="exampleInputEmail1">Set Other page image</label>
                                <br>
