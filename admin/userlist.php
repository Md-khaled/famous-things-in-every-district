                                    ...
                                    <td class="pull-right">
                                        ...
                                        if (Session::get("adminRole")=='0') {
                                         ...
                                         <?php if ($result['block']==0) {
                                          ...
                                          ?>
                                        <a class="btn btn-danger" title="block user" onclick="return confirm('are you want to block user !')" href="?deluid=<?php echo($result['userId']) ;?>&buser=<?php echo($result['block']) ; ?>"><i class="fa fa-trash-o" aria-hidden="true"></i></a>
                                    <?php }else{ ?>
                                        <a class="btn btn-danger" title="unblock user" onclick="return confirm('are you want to unblock user !')" href="?deluid=<?php echo($result['userId']) ;?>&buser=<?php echo($result['block']) ; ?>"><i class="fa fa-trash-o" aria-hidden="true"></i></a>
                                        <?php } ?>
                                    <?php } ?>
                                    </td>
                                </tr>
