    ...
    <div id="mainContent">
        ...
        ?>
            ...
            <div class="alert alert-success alert-dismissible" data-auto-dismiss="2000" role="alert">
                ...
                <strong style="color: green;">Success!</strong> <?php echo($insertCat);?>
            </div>
          <?php }?>
          <?php if(isset($delCate)) {?>
                        ...
                        <table id="table-datatables" class="table table-striped table-bordered" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="pull-right">
                                        <a class="btn btn-primary" href="catedit.php?catid=<?php echo($re['catId']) ;?>"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
                                        <?php 
                                        if (Session::get("adminRole")=='0') {
                                         ?>
                                        <a class="btn btn-danger" onclick="return confirm('are you sure delect category!')" href="?delete=<?php echo($re['catId']) ;?>"><i class="fa fa-trash-o" aria-hidden="true"></i></a>
                                    <?php } ?>
                                    </td>
                                </tr>
